...
@section('title','Credit Customer page')
@section('content')
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header" data-original-title>
                    <h2><a href="{{route('download-customer-report')}}" target="_blank"><span class="break"></span><i class="halflings-icon download"></i>Download Customer Report</a></h2>
                    <div class="box-icon">
                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        @foreach($payments as $key => $payment)
                            <tr>
                                ...
                                <td class="center">Tk. {{$payment->due_amount}}</td>
                                <td class="center">
                                    <a class="btn btn-info" href="{{route('edit-customer-credit',['invoice_id'=>$payment->invoice_id])}}" title="Edit">
