...
@section('title','View Purchase page')
@section('content')
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header" data-original-title>
                    <h2><i class="halflings-icon user"></i><span class="break"></span>Purchase</h2>
                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable datatable table-responsive">
                        ...
                        @foreach($purchases as $key => $purchase)
                            <tr>
                                ...
                                <td class="center">
                                    @if($purchase->status=='0')
                                        <a class="btn btn-danger" id="delete" href="{{route('delete-purchase',['id'=>$purchase->id])}}" title="Delete" >
