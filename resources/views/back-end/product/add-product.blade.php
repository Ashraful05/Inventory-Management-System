        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content">
                    <form action="{{route('save-product')}}" class="form-control-border" method="post" id="quickForm">
                        @csrf
                        ...
                        <br>
                        <div class="form-group">
                            <input type="submit" name="btn" value="Add Product Info" class="btn btn-success btn-block">
                        </div>
